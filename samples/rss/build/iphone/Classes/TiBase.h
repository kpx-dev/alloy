...
// in simulator we redefine to format for rss Developer console
...
{\
	NSString * exceptionName = [@"org.rss." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.rss";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIrssNativeItemNone = -1, 
	UIrssNativeItemSpinner = -2,
	UIrssNativeItemProgressBar = -3,
	
	UIrssNativeItemSlider = -4,
	UIrssNativeItemSwitch = -5,
	UIrssNativeItemMultiButton = -6,
	UIrssNativeItemSegmented = -7,
	
	UIrssNativeItemTextView = -8,
	UIrssNativeItemTextField = -9,
	UIrssNativeItemSearchBar = -10,
	
	UIrssNativeItemPicker = -11,
	UIrssNativeItemDatePicker = -12,
	
	UIrssNativeItemInfoLight = -13,
	UIrssNativeItemInfoDark = -14,
	
	UIrssNativeItemDisclosure = -15,
	
	UIrssNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all rss instances of
